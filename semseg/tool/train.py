...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/target/target_pspnet50.yaml', help='config file')
    parser.add_argument('opts', help='see config/target/target_pspnet50.yaml for all options', default=None, nargs=argparse.REMAINDER)
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    #         image = toi(images[j])
    #         image.save(os.path.join(args.save_path, f'image_{i * len(train_loader) + j}.png'))
    ####
