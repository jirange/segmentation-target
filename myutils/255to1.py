...
#-----------------------------------------------------------------------------------#
Origin_SegmentationClass_path   = "semseg/dataset/target/label"
Out_SegmentationClass_path      = "semseg/dataset/target/label-1"
...
# Out_Point_Value                 = np.array([0, 255])
if __name__ == "__main__":
    ...
    for png_name in tqdm(png_names):
        ...
        png_name = png_name.replace('.png', '.jpg')
